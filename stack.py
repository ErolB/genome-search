...
class Ui_StackedWidget(object):
    ...
    def setupUi(self, StackedWidget):
        ...
        self.loading_progress = QtWidgets.QProgressBar(self.patric_page)
        self.loading_progress.setProperty("value", 24)
        self.loading_progress.setObjectName("loading_progress")
        self.gridLayout_2.addWidget(self.loading_progress, 10, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.hmm_button, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.remove_search_button, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.psi_button, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.search_genomes_button, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.motif_button, 4, 0, 1, 1)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setContentsMargins(-1, 0, -1, -1)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_6 = QtWidgets.QLabel(self.search_menu)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_2.addWidget(self.label_6)
        self.evalue_field = QtWidgets.QLineEdit(self.search_menu)
        self.evalue_field.setObjectName("evalue_field")
        self.horizontalLayout_2.addWidget(self.evalue_field)
        self.change_button = QtWidgets.QPushButton(self.search_menu)
        self.change_button.setObjectName("change_button")
        self.horizontalLayout_2.addWidget(self.change_button)
        self.reset_button = QtWidgets.QPushButton(self.search_menu)
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.label_6.setText(_translate("StackedWidget", "Edit E-value"))
        self.change_button.setText(_translate("StackedWidget", "Change"))
        self.reset_button.setText(_translate("StackedWidget", "Reset"))
    ...
    def wiring(self, stack):
        ...
        self.fasta_button.clicked.connect(lambda: stack.setCurrentIndex(1))
        ...
        def show_threshold():
            selection = self.to_be_searched.currentItem().text()
            value = self.search_objects[selection].threshold
            self.evalue_field.setText(str(value))

        def reset_threshold_text():
            selection = self.to_be_searched.currentItem().text()
            original_value = self.search_objects[selection].threshold
            self.evalue_field.setText(str(original_value))

        def change_threshold():
            selection = self.to_be_searched.currentItem().text()
            search_obj = self.search_objects[selection]
            new_value = self.evalue_field.text()
            search_obj.set_threshold(float(new_value))
        ...
        self.continue_button.clicked.connect(lambda: stack.setCurrentIndex(3))
        ...
        self.to_be_searched.currentItemChanged.connect(show_threshold)
        self.change_button.clicked.connect(change_threshold)
        self.reset_button.clicked.connect(reset_threshold_text)
